		...
		<footer id={styles.Footer}>
			<div className={styles.CTA_nav_container}>
				<section className={styles.CTA}>
					<h2>
						Curate your{' '}
						<span style={{ display: 'inline-block' }}>experience today.</span>
					</h2>
				...
				<section className={styles.nav}>
					<ul id={styles.contact} className={styles.nav__section}>
						<li>
							<h3 className={styles.header}>Reach Out</h3>
						</li>
						<li>
							<p>Thy Parra</p>
						</li>
						...
						<li>
							<a className={styles.tel} href='tel:202 957 2846'>
								202.957.2846
							</a>
						</li>
						<li>
							<a className={styles.tel} href='mailto:thy@cocktailcurations.com'>
								thy@cocktailcurations.com
							</a>
						</li>
						...
						<li>
							<a className={styles.tel} href='tel:202 577 5376'>
								202.577.5376
							</a>
						</li>
						<li>
							<a className={styles.tel} href='mailto:nicole@cocktailcurations.com'>
								nicole@cocktailcurations.com
							</a>
						</li>
					</ul>
